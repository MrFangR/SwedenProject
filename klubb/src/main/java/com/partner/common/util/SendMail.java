...
public class SendMail {
	...
	public static void sendMessage(String smtpHost, String from,
		...
		props.put("mail.password",fromUserPassword);
		...
		transport.connect(smtpHost,"fangrui8452", fromUserPassword);
	...
	public static void main(String[] args) {
		try {
			SendMail.sendMessage("smtp.qq.com", "50004171@qq.com",
					"mgmbdkqqirvbbjdi", "fangrui8452@126.com", "修改密码",
					"---------------wrwe-----------",
