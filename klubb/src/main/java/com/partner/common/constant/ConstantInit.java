...
/**
 * config.properties閰嶇疆鏂囦欢瀵瑰簲鐨刱ey
 */
public interface ConstantInit {
	 ...
	 * 与通云平台saas的相关参数
	 */
	public static final String saas_key="SAAS.KEY";
	public static final String saas_app_id="SAAS.APP_ID";
	public static final String saas_si_id="SAAS.SI_ID";
	public static final String saas_ws_url="SAAS.WS_URL";
	public static final String saas_portal_url="SAAS.PORTAL_URL";
}
