  ...
  <div class="cont-con">
     ...
     <div class="main_body xmfb_con">
         <div class="xmfb_title">
           <h2 style="margin-left:60px;">找回密码</h2>
         </div>
         <!-- 取消找回密码步骤显示
                     ...
                     -->
						<div class="us-bd-base xmfb_con_text">
                                    <dl  class="us-info-dl clearfix">
										...
										<dd class="fl"><input  type="text" id="email" /></dd>
										<dd class="notice" id="email_notice"></dd>
									</dl>
                                   <dl class="us-info-dl clearfix">
										<dt class="fl"><span class="rose">*</span>验证码：</dt>
										<dd class="fl">
									    	<input type="text" id="imgcode" name="imgcode" maxlength="4" class="ued-input fl" style="width:100px;" /> 
											<img id="randCodeImage" class="mgl-10" style="height: 40px;" src="${ctx}/front/randCodeImage" /> 
