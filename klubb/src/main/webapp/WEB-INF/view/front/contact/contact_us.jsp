...
<body class="tm-background">
	...
	<div class="list-con">
		<div class="mapcon">
			<iframe style="width: 1200px;height: 685px;"
				src="https://www.google.com/maps/embed/v1/place?q=place_id:ChIJH3bGnUxnZEYRIGEWn6ybP2g&zoom=17&key=AIzaSyAnSqMOGPqI615A_ASt5pWkDqDP987OdaM"></iframe>
		</div>
	</div>
	<!--cont-con E-->
	...
	<div class="contactq">
		<div class="contact-left">
			<div class="list-contitle">
				<i18n:get key="portal.contact.form.title"></i18n:get>
			</div>
			<!--us-bd-base S-->
			<div class="us-bd-base xmfb_con_text">
				...
				<form enctype="multipart/form-data" id="contactForm">
					<dl class="us-info-dl clearfix">
						<dt class="fl">
							...
							<i18n:get key="portal.contact.form.name"></i18n:get>
							:
						</dt>
						<dd class="fl">
					...
					<dl class="us-info-dl clearfix">
						<dt class="fl">
							<span class="rose">*</span>
							<i18n:get key="portal.contact.form.phone"></i18n:get>
							:
						</dt>
						<dd class="fl">
					...
					<dl class="us-info-dl clearfix">
						<dt class="fl">
							<span class="rose">*</span>
							<i18n:get key="portal.contact.form.content"></i18n:get>
							:
						</dt>
						<dd class="fl">
							<textarea cols="" rows="5" name="contact.CONTENT"></textarea>
						</dd>
					...
					<dl class="us-info-dl clearfix">
						<dt class="fl">
							<span class="rose">*</span>
							<i18n:get key="portal.contact.form.code"></i18n:get>
							:
						</dt>
						<dd class="fl">
							<input style="width:100px;" type="text" name="code"> <img
								id="codeImg" onclick="getRandImg()">
						</dd>
				...
				<dl class="us-info-dl clearfix">
					<dt class="fl">&nbsp;</dt>
					<dd class="fl">
						<div class="us-btn" onclick="save()">
							<i18n:get key="portal.contact.form.submit"></i18n:get>
						</div>
					</dd>
				</dl>
		...
		<div class="contact-right">
			<h2>
				<i18n:get key="portal.contact.info.title"></i18n:get>
			</h2>
