 ...
 <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
     <div class="header-con">
         ...
         <span class="fr" style="width:200px">
         	...
         	<c:if test="${FRONT_SESSION_USER.EMAIL != null }">
         		<a href="${ctx }/userCenter/toActMan">${FRONT_SESSION_USER.NICKNAME }</a> | <a href="javascript:logout();"><i18n:get key="portal.menu.logout"></i18n:get></a>
         	</c:if>
         </span>
        <nav class="menu-body">
          <ul>
            ...
            <li class="jsli" width="738" url="userCenter"><a href="${ctx }/userCenter/toActMan"><i18n:get key="portal.menu.center"></i18n:get></a></li>
            <li class="line"></li>
           </ul>
        </nav>
